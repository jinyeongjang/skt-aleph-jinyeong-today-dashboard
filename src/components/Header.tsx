        ...
        <div className="flex items-center gap-1.5">
          {activeMode === 'live' && (
            <button
              ...
              className="hover-lift active-press inline-flex min-w-8.5 items-center justify-center gap-1.5 rounded-xl bg-neutral-900/90 px-3 py-1.5 text-xs font-semibold text-white shadow-xs backdrop-blur-sm transition-all hover:bg-neutral-800 disabled:opacity-50 md:min-w-24.5 dark:bg-neutral-100/90 dark:text-neutral-900 dark:hover:bg-neutral-200"
