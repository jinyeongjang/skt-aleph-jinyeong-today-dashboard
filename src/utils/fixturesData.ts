import type { FixtureItem } from '../types/board';

export const FIXTURE_NORMAL_D1_A: FixtureItem = {
...
export const FIXTURE_NORMAL_D1_B: FixtureItem = {
...
export const FIXTURE_NORMAL_D2: FixtureItem = {
...
export const FIXTURE_TIMEOUT: FixtureItem = {
...
export const FIXTURE_AUTH_401: FixtureItem = {
...
export const FIXTURE_RATE_429: FixtureItem = {
...
export const FIXTURE_OFFLINE: FixtureItem = {
...
export const FIXTURE_SCHEMA_BREAK: FixtureItem = {
  ...
  payload: {
    signal_id: 'aleph-demo-index',
    normalized_value: '105', // number여야 하나 문자열로 전송됨
    unit: 'pt',
    source_name: 'ALEPH 결정론 replay',
    source_url: 'https://fixtures.aleph.invalid/t04/demo-index',
    source_time: null,
...
export const FIXTURE_RECOVER_D2: FixtureItem = {
...
export const ALL_FIXTURES: readonly FixtureItem[] = Object.freeze([
  FIXTURE_NORMAL_D1_A,
  FIXTURE_NORMAL_D1_B,
  FIXTURE_NORMAL_D2,
  FIXTURE_TIMEOUT,
  ...
  FIXTURE_RATE_429,
  FIXTURE_OFFLINE,
  FIXTURE_SCHEMA_BREAK,
  FIXTURE_RECOVER_D2,
]);

export const FAILURE_FIXTURES: readonly FixtureItem[] = Object.freeze([
  FIXTURE_TIMEOUT,
  FIXTURE_AUTH_401,
  FIXTURE_RATE_429,
  FIXTURE_OFFLINE,
